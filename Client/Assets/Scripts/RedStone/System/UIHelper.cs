...
public class UIHelper
{
    ...
    public static void SetButtonSpriteState(Hotfire.UI.Button btn, Sprite highlightedSprite = null, Sprite pressedSprite = null, Sprite disabledSprite = null)
    {
    ...
    {
        var texts = ListPool<Hotfire.UI.Text>.Get();
        gameObject.GetComponentsInChildren<Hotfire.UI.Text>(true, texts);
    ...
    public static void ReloadFontStyle(GameObject gameObject)
    {
        if (gameObject == null)
            return;
        foreach (Hotfire.UI.Text text in gameObject.GetComponentsInChildren<Hotfire.UI.Text>(true))
        {
