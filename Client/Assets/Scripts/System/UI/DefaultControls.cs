 ...
 namespace RedStone.UI
{
    public static class DefaultControls
    {
        ...
        public static GameObject CreateButton(Resources resources)
        {
			...
			bt.SetSprite ("common_white","common_white","common_white");
        ...
        public static GameObject CreateGameObject(Resources resources)
        {
            GameObject go = CreateUIElementRoot("GameObejct", Vector2.zero);
            return go;
        }
		...
		public static GameObject CreateClickableNonDrawingGraphics(Resources resources)
		{
			GameObject go = CreateUIElementRoot("Clickable", s_ImageElementSize);
			var img = go.AddComponent<NonDrawingGraphic>();
			img.raycastTarget = true;
			go.AddComponent<UUIEventListener> ();
			return go;
		}
		public static GameObject CreateAnimProgressBar(Resources resources)
		{
			// Create GOs Hierarchy
			GameObject root = CreateUIElementRoot("Progress", s_ThinElementSize);
			...
			fillImage.SetSprite ("common_white");
			...
			handleImage.SetSprite ("common_white");
			...
			AnimateProgressBar slider = root.AddComponent<AnimateProgressBar>();
			slider.fillRect = fill.GetComponent<RectTransform>();
			slider.handleRect = handle.GetComponent<RectTransform>();
			slider.animLength = 2f;
		...
		public static GameObject CreateSimpleSlider(Resources resources)
		{
			GameObject root = CreateUIElementRoot("Simple Slider", s_ThinElementSize);
			GameObject imgGo = CreateUIObject("Image", root);
			var image = imgGo.AddComponent<Image> ();
			image.raycastTarget = false;
			var slider = root.AddComponent<SimpleSlider> ();

			slider.rectTransform.pivot = Vector3.zero;
		...
		public static GameObject CreateLine(Resources resources)
		{
			GameObject scrollbarRoot = CreateUIElementRoot("Line", s_ThinElementSize);
			scrollbarRoot.AddComponent<UILineRenderer> ();
        ...
        public static GameObject CreateScrollbar(Resources resources)
        {
			...
			bgImage.SetSprite ("common_white");
        ...
        public static GameObject CreateToggle(Resources resources)
        {
			...
			checkmarkImage.SetSprite ("common_white");
			checkmarkImage.color = Color.black;
            checkmarkImage.type = UnityEngine.UI.Image.Type.Sliced;
        ...
        public static GameObject CreateInputField(Resources resources)
        {
            ...
            UnityEngine.UI.Text text = childText.AddComponent<UnityEngine.UI.Text>();
            text.text = "";
        ...
        public static GameObject CreateListView(Resources resources)
        {
            GameObject root = CreateScrollView(resources);
            GameObject content = root.transform.Find("Viewport/Content").gameObject;

			content.AddComponent<ListLayoutGroup>();
		...
		public static GameObject CreateFlexibleListView(Resources resources)
		{
			GameObject root = CreateScrollView(resources);
			GameObject content = root.transform.Find("Viewport/Content").gameObject;

			var listLayoutGroup = content.AddComponent<FlexibleListLayoutGroup>();
			listLayoutGroup.scrollRect = root.GetComponent<ScrollRect> ();
			var fitter = content.AddComponent<UnityEngine.UI.ContentSizeFitter> ();
			fitter.horizontalFit = UnityEngine.UI.ContentSizeFitter.FitMode.MinSize;
			fitter.verticalFit = UnityEngine.UI.ContentSizeFitter.FitMode.MinSize;
			return root;
		}
        ...
        public static GameObject CreateScrollView(Resources resources)
        {
			...
			rootImage.SetSprite ("common_white");
