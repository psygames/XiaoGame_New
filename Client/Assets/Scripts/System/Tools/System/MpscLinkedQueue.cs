...
namespace RedStone
{
    ...
    sealed public class MpscLinkedQueue<T> : MpscLinkedQueueTailRef<T>, IEnumerable<T>
    {
...
#pragma warning restore 169
        ...
        {
            MpscLinkedQueueNode<T> next = this.PeekNode();
			return next == null ? default(T) : next.Value;
        }
    ...
    public abstract class MpscLinkedQueueHeadRef<T> : MpscLinkedQueuePad0<T>
    {
    ...
    public abstract class MpscLinkedQueuePad0<T>
    {
#pragma warning disable 169 // padded reference
        long p00, p01, p02, p03, p04, p05, p06, p07;
        long p30, p31, p32, p33, p34, p35, p36, p37;
#pragma warning restore 169
    ...
    public abstract class MpscLinkedQueuePad1<T> : MpscLinkedQueueHeadRef<T>
    {
#pragma warning disable 169 // padded reference
        long p00, p01, p02, p03, p04, p05, p06, p07;
        long p30, p31, p32, p33, p34, p35, p36, p37;
#pragma warning restore 169
    ...
    public abstract class MpscLinkedQueueTailRef<T> : MpscLinkedQueuePad1<T>
    {
